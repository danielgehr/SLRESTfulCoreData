Pod::Spec.new do |spec|
  ...
  spec.license      = 'MIT'
  spec.source       = { :git => 'https://github.com/danielgehr/SLRESTfulCoreData.git', :branch => '1.3.9' }
  spec.frameworks   = 'Foundation', 'UIKit', 'CoreData'
  spec.requires_arc = true
  spec.homepage     = 'https://github.com/danielgehr/SLRESTfulCoreData'
  ...
  spec.author       = { 'Daniel Gehr' => 'daniel.gehr@protonmail.ch' }
  ...
  spec.subspec 'Complete' do |sp|
    ...
    sp.dependency 'AFNetworking', '= 1.3.4'
    sp.dependency 'SLCoreDataStack', '= 0.8.8'
  end
end
